        ...
        <div className="order-1 md:order-2">
          ...
          <div className="space-y-4 text-[var(--text-muted)] text-sm md:text-base leading-relaxed">
            <p>
              ...
              iniciei minha jornada pessoal com o yoga, um caminho que me levou a
              descobrir um profundo amor e respeito por essa prática milenar.
            </p>
            <p>
              Em 2014, tive a oportunidade de aprofundar meus estudos no Ashram da Amma,
              na Índia, mergulhando nas técnicas e filosofias do yoga. Desde então,
              tenho dedicado minha vida não apenas à minha prática, mas também à
              disseminação dos ensinamentos do yoga.
            </p>
            <p>
