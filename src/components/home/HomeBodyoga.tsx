    ...
    <section className="py-20 md:py-28 bg-bodyoga-cream overflow-hidden">
      <div className="w-full relative flex flex-col md:flex-row items-center justify-between min-h-[500px] md:min-h-[600px]">
        ...
        <div className="md:hidden flex w-full gap-2 mt-12 px-4">
           <img src="/images/home/bodyoga/bodyoga-left.png" className="w-1/2 aspect-[3/4] object-cover rounded-sm" alt=""  loading="lazy" decoding="async" />
           <img src="/images/home/bodyoga/bodyoga-right.png" className="w-1/2 aspect-[3/4] object-cover rounded-sm" alt=""  loading="lazy" decoding="async" />
        </div>
