...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Elisa Hoeppers | Movimente seu corpo, cuide da sua mente." },
      { name: "description", content: "Professora de Yoga, fundadora do BODYOGA e perfumista. Movimente seu corpo, cuide da sua mente." },
      { property: "og:title", content: "Elisa Hoeppers | Movimente seu corpo, cuide da sua mente." },
      { property: "og:description", content: "Professora de Yoga, fundadora do BODYOGA e perfumista." },
