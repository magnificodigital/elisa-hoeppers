      ...
      <section className="py-12 md:py-20 bg-[var(--surface-cream)] min-h-screen">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="space-y-3">
            {(products ?? []).map((p) => (
              <div key={p.id} className="bg-bodyoga-cream border border-border/20 rounded-lg p-4 flex items-center gap-4 shadow-none">
...
function InstagramFeedCard() {
  ...
  return (
    <div className="bg-bodyoga-cream border border-border/20 rounded-lg p-5 mb-8">
