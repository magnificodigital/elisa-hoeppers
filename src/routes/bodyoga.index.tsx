      ...
      <section className="relative overflow-hidden bg-bodyoga-cream -mt-24 pt-24">
        ...
        <div className="relative z-10 max-w-[1170px] mx-auto px-4 md:px-6 pt-40 md:pt-56 pb-24 md:pb-36 flex items-center justify-start min-h-[85vh]">
          <div className="relative max-w-xl">
            <div className="absolute -inset-x-10 -inset-y-8 backdrop-blur-md [mask-image:radial-gradient(ellipse_at_center,black_55%,transparent_85%)] [-webkit-mask-image:radial-gradient(ellipse_at_center,black_55%,transparent_85%)] pointer-events-none" />
